...
In this guide, we'll create an easy-peasy reference app that uses the core powers of Supabase. This app is as basic as it gets, making it your go-to reference for future projects.
...
Project Link : https://codesandbox.io/p/sandbox/supabase-auth-example-l9shkq